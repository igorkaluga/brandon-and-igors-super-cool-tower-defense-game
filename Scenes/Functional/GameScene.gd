...
func retrieve_wave_data():
	var wave_data = [["GoblinEnemy", 1.0], ["GoblinEnemy", 0.5], ["GoblinEnemy", 0.5], ["GoblinEnemy", 0.5], ["GoblinEnemy", 0.5], ["GoblinEnemy", 0.5], ["GoblinEnemy", 0.5]]
	current_wave += 1
